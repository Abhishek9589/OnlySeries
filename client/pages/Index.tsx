...
import { Download, Upload, ArrowDown, ArrowUp } from "lucide-react";
...
export default function Index() {
  ...
  const detectFranchise = (title: string): string | undefined => {
  ...
  const uploadBookmarks = (event: React.ChangeEvent<HTMLInputElement>) => {
